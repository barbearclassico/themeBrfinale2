...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">
	...
	echo '		<div class="user">';
	echo '			<img align="left" src="' . $settings['images_url'] . '/smflogo.png" alt="Barbear Clássico" title="Barbear Clássico" />';
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li><b>BR Finale</b> 2011 by, <a href="http://www.jpr62.com/theme/" target="_blank" class="new_win" title=""><span>Crip</span></a></li>
		</ul>';
